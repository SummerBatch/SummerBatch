...
namespace Summer.Batch.Core.Launch
{
    ...
    /// </summary>
    [Serializable]
    public class JobExecutionNotFailedException : JobExecutionException
    {
        /// <summary>
        ...
        public JobExecutionNotFailedException(string msg, Exception e)
            : base(msg, e)
        { }
        ...
        protected JobExecutionNotFailedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }
    }
}
