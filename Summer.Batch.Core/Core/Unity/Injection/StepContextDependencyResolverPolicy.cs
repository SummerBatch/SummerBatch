...
{
    /// <summary>
    /// Dependency resolver that reads a property from the step context.
    /// </summary>
    public class StepContextDependencyResolverPolicy<T> : IDependencyResolverPolicy
    {
        private readonly string _propertyName;

        /// <summary>
        /// Constructs a new StepContextDependencyResolverPolicy.
        /// </summary>
        /// <param name="propertyName">the name of the property to read</param>
        public StepContextDependencyResolverPolicy(string propertyName)
        {
