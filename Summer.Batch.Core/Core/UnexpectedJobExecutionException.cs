...
namespace Summer.Batch.Core
{
    ...
    /// </summary>
    [Serializable]
    public class UnexpectedJobExecutionException : Exception
    {
        /// <summary>
        ...
        public UnexpectedJobExecutionException(string msg, Exception nested)
            : base(msg, nested)
        { }
        ...
        protected UnexpectedJobExecutionException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {}
