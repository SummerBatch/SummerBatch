...
namespace Summer.Batch.Core.Partition.Support
{
    ...
    /// step in the form of <see cref="ExecutionContext"/> instances. The usual aim is to
    ...
    {
        /// <summary>
        ///  Create a set of distinct <see cref="ExecutionContext"/> instances together with
        ...
        /// <returns></returns>
        IDictionary<string, ExecutionContext> Partition(int gridSize);
    }
}