...
namespace Summer.Batch.Infrastructure.Item
{
    ...
    /// </summary>
    [Serializable]
    public class WriterNotOpenException : ItemWriterException
    {
        /// <summary>
        ...
        public WriterNotOpenException(string message, Exception exception) : base(message, exception)
        {
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        public WriterNotOpenException(string message) : base(message)
        {
        }
    }
}